...
export async function createNotification(
  ...
  export async function createNotificationForRole(
    ...
    try {
      const response = await fetch("https://adndash.squareweb.app/api/notifications/role", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  export async function checkScheduledEvents() {
    try {
      ...
      const clientesResponse = await fetch("https://adndash.squareweb.app/api/clientes/seguimiento", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
      ...
      const reclamosResponse = await fetch("https://adndash.squareweb.app/api/postventa/pendientes", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
      ...
      const visitasResponse = await fetch(
        `https://adndash.squareweb.app/api/postventa/visitas?fecha=${tomorrowStr}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
