...
export const domePalermoData = {
  ...
  parkingConfig: {
    ...
    totalSpots: 45,
    parkingInfo:
      "Disponemos de 45 espacios de estacionamiento subterráneo distribuidos en 3 niveles. Costo adicional de $15,000 por unidad. Acceso con tarjeta magnética y vigilancia 24/7.",
    spotsPerLevel: {
      1: 15,
      2: 15,
      3: 15,
  ...
  parkingSpots: [
    ...
    },
    {
      ...
      status: "available" as ApartmentStatus,
      assignedTo: null,
      path: "M420,513 L420,525 L420,538 L420,554 L420,567 L420,584 L420,603 L420,626 L420,637 L419,650 L430,657 L441,660 L457,659 L471,657 L474,646 L475,628 L478,616 L475,599 L474,583 L473,563 L475,552 L477,540 L477,529 L470,515 L457,508 L441,508 L430,508 Z",
    },
    {
      id: "A15",
      level: 1 as GarageLevel,
