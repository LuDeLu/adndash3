...
export default function EnviarInformacionTrabajador({ reclamo }: EnviarInformacionTrabajadorProps) {
...
`.trim()
  ...
  const enviarPorWhatsApp = (esGrupo: boolean) => {
    const mensaje = encodeURIComponent(informacionEsencial)
    if (esGrupo) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[350px]">
        ...
        <div className="py-4">
          <p className="text-center text-gray-600">¿Enviar a un contacto o a un grupo?</p>
        </div>
