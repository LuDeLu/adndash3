            ...
            <motion.div className="flex flex-col h-full lg:flex-row">
                          ...
                          <TooltipPrimitive.Provider key={floor.number}>
                            <TooltipPrimitive.Root delayDuration={0}>
                              <TooltipPrimitive.Trigger asChild>
                                <g onClick={() => onOpenFloorPlan(floor.number)} style={{ cursor: "pointer" }}>
                                  {/* Rectángulo vendido */}
                                  <motion.rect
                                    x={floor.x}
                                    y={floor.y}
              ...
              <div className="flex-1 flex flex-col overflow-hidden">
                            ...
                            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-1 sm:gap-2">
                              {floors.map((floor) => (
                                <Button
                                  ...
                                  onClick={() => onOpenFloorPlan(floor.number)}
                                >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 p-2 sm:p-4 bg-background border-t">
                  <Button onClick={() => onOpenFloorPlan()} className="w-full py-3 sm:py-6 text-xs sm:text-base">
                    Ver planos
                  </Button>
