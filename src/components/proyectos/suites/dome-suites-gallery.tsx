...
const galleryItems = [
  {
    id: 1,
    src: "/images/multimedia/suites/AIT-014-frontal_hall-00-con parking y hall real.webp",
    alt: "Fachada con acceso y parking",
    category: "exterior",
    type: "image",
    title: "Fachada Principal",
    description: "Vista frontal del edificio con acceso y estacionamiento",
  },
  {
    id: 2,
    src: "/images/multimedia/suites/AIT-011-EXT1-02_2.webp",
    alt: "Exterior del edificio vista 1",
    category: "exterior",
    type: "image",
  ...
  {
    id: 3,
    src: "/images/multimedia/suites/AIT-012-EXT2-01_1.webp",
    alt: "Exterior del edificio vista 2",
    category: "exterior",
    type: "image",
    title: "Vista Exterior",
    description: "Perspectiva exterior del proyecto",
  },
  {
    id: 4,
    src: "/images/multimedia/suites/AIT-013-EXT3-01_1.webp",
    alt: "Exterior del edificio vista 3",
    category: "exterior",
    type: "image",
    title: "Vista Exterior",
  ...
  {
    id: 5,
    src: "/images/multimedia/suites/AIT-01-PILETA-04.webp",
    alt: "Piscina",
    category: "amenities",
    type: "image",
    title: "Piscina",
  ...
  {
    id: 6,
    src: "/images/multimedia/suites/AIT-002-PARRILLAS-04_.webp",
    alt: "Parrillas",
    category: "amenities",
    type: "image",
    title: "Parrillas",
    description: "Sector de parrillas",
  },
  {
    id: 7,
    src: "/images/multimedia/suites/AIT-03-PARRILLAS-006.webp",
    alt: "Parrillas vista alternativa",
    category: "amenities",
    type: "image",
    title: "Parrillas",
    description: "Vista adicional del sector de parrillas",
  },
  {
    id: 8,
    src: "/images/multimedia/suites/sum.webp",
    alt: "SUM",
    category: "amenities",
    type: "image",
    title: "SUM",
  ...
  {
    id: 9,
    src: "/images/multimedia/suites/hall.webp",
    alt: "Hall de acceso",
    category: "interior",
    type: "image",
  ...
  {
    id: 10,
    src: "/images/multimedia/suites/AIT-015-DETALLE-02.webp",
    alt: "Detalle constructivo",
    category: "interior",
    type: "image",
    title: "Detalle",
    description: "Detalle de diseño y terminaciones",
  },
  {
    id: 11,
    src: "/images/multimedia/suites/in1.webp",
    alt: "Interior suite vista 1",
    category: "interior",
    type: "image",
    title: "Interior Suite",
    description: "Vista interior de la suite",
  },
  {
    id: 12,
    src: "/images/multimedia/suites/in2.webp",
    alt: "Interior suite vista 2",
    category: "interior",
    type: "image",
    title: "Interior Suite",
    description: "Espacio interior de la suite",
  },
  {
    id: 13,
    src: "/images/multimedia/suites/in3.webp",
    alt: "Interior suite vista 3",
    category: "interior",
    type: "image",
    title: "Interior Suite",
    description: "Diseño interior de la unidad",
  },
  {
    id: 14,
    src: "/images/multimedia/suites/in4.webp",
    alt: "Interior suite vista 4",
    category: "interior",
    type: "image",
    title: "Interior Suite",
    description: "Ambiente interior con terminaciones modernas",
  },
  {
    id: 15,
    src: "/images/multimedia/suites/suitestandar.webp",
    alt: "Suite estándar",
    category: "interior",
    type: "image",
    title: "Suite Estándar",
    description: "Unidad tipo estándar",
  },
  {
    id: 16,
    src: "/images/multimedia/suites/suitesenior.webp",
    alt: "Suite senior",
    category: "interior",
    type: "image",
    title: "Suite Senior",
    description: "Unidad senior de mayor superficie",
  },
  {
    id: 17,
    src: "/images/multimedia/suites/suitedeluxe.webp",
    alt: "Suite deluxe",
    category: "interior",
    type: "image",
    title: "Suite Deluxe",
    description: "Unidad deluxe con detalles premium",
  },
];
  ...
  const handleDownload = (src: string, title: string) => {
    ...
    link.href = src
    link.download = `dome-suites-${title.toLowerCase().replace(/\s+/g, "-")}.webp`
