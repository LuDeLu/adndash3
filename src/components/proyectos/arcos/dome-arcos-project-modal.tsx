...
import { arcosFloorsData, type ArcosApartment, type ArcosApartmentStatus } from "@/lib/dome-arcos-data"

interface DomeArcosProjectModalProps {
  isOpen: boolean
  onClose: () => void
  onViewProject: () => void
  onViewGallery: () => void
...
export function DomeArcosProjectModal({
  isOpen,
  onClose,
  onViewProject,
  onViewGallery,
  onViewPlanes,
}: DomeArcosProjectModalProps) {
  ...
  const { unitStatuses, refresh } = useUnitStorage("arcos")
  ...
  const floors: Floor[] = useMemo(() => {
    return arcosFloorsData.map((floorData, index) => {
      ...
      return {
        ...
        x: 448,
        y: 680 - index * 27, // Adjusted spacing for 24 floors
      }
    })
  }, [getRealStatus])
  ...
  const projectData = useMemo(() => {
    ...
    return {
      ...
      location: "Av. Del Libertador, Olivos",
      image: "/images/edificio/arcosedi.webp",
      description:
        "Exclusivo desarrollo de 24 pisos con 50 unidades residenciales de alta gama en Olivos, con vista al río y amenities de primer nivel.",
                ...
                <ScrollArea className="flex-1 p-4 sm:p-6">
                  <DialogHeader className="space-y-2 pb-4">
                    <div className="flex items-center space-x-3">
                      <Image
                        src={"/images/logo/arcoslogo.webp"}
                        alt="DOME Logo"
                        width={50}
                        height={50}
                  ...
                  <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)} className="w-full">
                    ...
                    <TabsContent value="units" className="mt-2">
                      <div className="space-y-4 mt-4">
                        ...
                        <div className="bg-muted p-4 rounded-lg">
                          <h5 className="font-medium">2 Dormitorios</h5>
                          <p className="text-sm text-muted-foreground">Superficie: 76-95 m²</p>
                          <p className="text-sm text-muted-foreground">Rango de precios: USD 382.300 - 519.400</p>
                          <p className="text-sm text-muted-foreground">Estado: Disponible</p>
                        </div>
                        <div className="bg-muted p-4 rounded-lg">
                          <h5 className="font-medium">3 Dormitorios</h5>
                          <p className="text-sm text-muted-foreground">Superficie: 108-175 m²</p>
                          <p className="text-sm text-muted-foreground">Rango de precios: USD 517.100 - 881.300</p>
                          <p className="text-sm text-muted-foreground">Estado: Disponible</p>
                        </div>
                        <div className="bg-muted p-4 rounded-lg">
                          <h5 className="font-medium">Pisos 360°</h5>
                          <p className="text-sm text-muted-foreground">Superficie: 184-192 m²</p>
                          <p className="text-sm text-muted-foreground">Rango de precios: USD 1.034.400 - 1.701.000</p>
                          <p className="text-sm text-muted-foreground">Estado: Disponible</p>
                        </div>
                      </div>
                    </TabsContent>
                      ...
                      <div className="space-y-4 mt-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          {[
                            ...
                            "Gimnasio equipado",
                            "Sala de reuniones",
                            "Terraza panorámica con vista al río",
                            "Cocheras cubiertas (4 niveles)",
                            "Seguridad 24hs",
                            "Sum con parrilla",
                            "Solarium",
                          ].map((amenity, index) => (
                    ...
                    <TabsContent value="financial" className="mt-2">
                      <div className="space-y-4 mt-4">
                        ...
                        <div className="bg-muted p-4 rounded-lg">
                          <h5 className="font-medium">Reserva</h5>
                          <p className="text-sm text-muted-foreground">10% al momento de la reserva</p>
                        </div>
                        <div className="bg-muted p-4 rounded-lg">
                          <h5 className="font-medium">Al Boleto</h5>
                          <p className="text-sm text-muted-foreground">30% al firmar boleto de compra-venta</p>
                        </div>
                        <div className="bg-muted p-4 rounded-lg">
                          <h5 className="font-medium">Cuotas durante construcción</h5>
                          <p className="text-sm text-muted-foreground">44 cuotas mensuales (aprox. 60% del saldo)</p>
                        </div>
                        <div className="bg-muted p-4 rounded-lg">
                          <h5 className="font-medium">Entrega</h5>
                          <p className="text-sm text-muted-foreground">Saldo restante contra entrega de llaves</p>
                        </div>
                      </div>
                    </TabsContent>
                    ...
                    <TabsContent value="location" className="mt-2">
                      <div className="space-y-6 mt-4">
                        ...
                        <div className="bg-muted rounded-lg overflow-hidden shadow-md aspect-video">
                          <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3287.4234!2d-58.4950!3d-34.5075!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzTCsDMwJzI3LjAiUyA1OMKwMjknNDIuMCJX!5e0!3m2!1sen!2sar!4v1234567890"
                            width="100%"
                            height="100%"
                            style={{ border: 0 }}
                            allowFullScreen
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="bg-muted p-6 rounded-lg shadow-md">
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                              ...
                              <li>
                                <span className="font-semibold text-foreground">Barrio:</span> Olivos
                              </li>
                              <li>
                          ...
                          <div className="bg-muted p-6 rounded-lg shadow-md">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Ubicado en Olivos, con vista privilegiada al río. Acceso a estaciones de tren, comercios,
                              gastronomía y espacios verdes.
                            </p>
                          </div>
                        </div>
                      </div>
