...
interface DomeArcosGalleryProps {
  onReturnToProject: () => void
}

export function DomeArcosGallery({ onReturnToProject }: DomeArcosGalleryProps) {
  ...
  const galleryItems = [
    {
      id: 1,
      src: "/images/multimedia/arcos/exterior-1.webp",
      alt: "Fachada principal Torre Arcos",
      category: "exterior",
      type: "image",
      title: "Fachada Principal",
      description: "Vista frontal del edificio Torre Arcos",
    },
    {
      id: 2,
      src: "/images/multimedia/arcos/exterior-2.webp",
      alt: "Vista exterior Torre Arcos",
      category: "exterior",
      type: "image",
    ...
    {
      id: 3,
      src: "/images/multimedia/arcos/exterior-3.webp",
      alt: "Perspectiva Torre Arcos",
      category: "exterior",
      type: "image",
      title: "Perspectiva Exterior",
      description: "Perspectiva del proyecto Torre Arcos",
    },
    {
      id: 4,
      src: "/images/multimedia/arcos/terraza.webp",
      alt: "Terraza Torre Arcos",
      category: "amenities",
      type: "image",
      title: "Terraza",
      description: "Terraza con vistas panorámicas",
    },
    {
      id: 5,
      src: "/images/multimedia/arcos/piscina.webp",
      alt: "Piscina Torre Arcos",
      category: "amenities",
      type: "image",
      title: "Piscina",
      description: "Área de piscina climatizada",
    },
    {
      id: 6,
      src: "/images/multimedia/arcos/sum.webp",
      alt: "SUM Torre Arcos",
      category: "amenities",
      type: "image",
      title: "SUM",
    ...
    {
      id: 7,
      src: "/images/multimedia/arcos/gym.webp",
      alt: "Gimnasio Torre Arcos",
      category: "amenities",
      type: "image",
      title: "Gimnasio",
    ...
    {
      id: 8,
      src: "/images/multimedia/arcos/hall.webp",
      alt: "Hall de acceso Torre Arcos",
      category: "interior",
      type: "image",
    ...
    {
      id: 9,
      src: "/images/multimedia/arcos/living-2dorm.webp",
      alt: "Living 2 dormitorios",
      category: "interior",
      type: "image",
      title: "Living 2 Dormitorios",
      description: "Vista del living en unidad de 2 dormitorios",
    },
    {
      id: 10,
      src: "/images/multimedia/arcos/living-3dorm.webp",
      alt: "Living 3 dormitorios",
      category: "interior",
      type: "image",
      title: "Living 3 Dormitorios",
      description: "Vista del living en unidad de 3 dormitorios",
    },
    {
      id: 11,
      src: "/images/multimedia/arcos/cocina.webp",
      alt: "Cocina Torre Arcos",
      category: "interior",
      type: "image",
      title: "Cocina",
      description: "Cocina integrada con terminaciones premium",
    },
    {
      id: 12,
      src: "/images/multimedia/arcos/dormitorio.webp",
    ...
    {
      id: 13,
      src: "/images/multimedia/arcos/balcon.webp",
      alt: "Balcón Torre Arcos",
      category: "interior",
      type: "image",
      title: "Balcón",
      description: "Balcón con vistas panorámicas",
    },
    {
      id: 14,
      src: "/images/multimedia/arcos/cochera-nivel1.webp",
      alt: "Cochera nivel 1",
      category: "parking",
      type: "image",
      title: "Cochera Nivel 1",
      description: "Espacios de cochera en nivel 1",
    },
    {
      id: 15,
      src: "/images/multimedia/arcos/cochera-nivel2.webp",
      alt: "Cochera nivel 2",
      category: "parking",
      type: "image",
      title: "Cochera Nivel 2",
      description: "Espacios de cochera en nivel 2",
    },
  ]
  ...
  const handleDownload = (src: string, title: string) => {
    ...
    link.href = src
    link.download = `torre-arcos-${title.toLowerCase().replace(/\s+/g, "-")}.webp`
    ...
    <div className="min-h-screen text-white">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-2xl font-bold">Galería - DOME Torre Arcos</h1>
          <div></div>
        </div>
...
export default DomeArcosGallery
