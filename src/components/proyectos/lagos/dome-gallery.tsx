...
const galleryData = {
  images: [
    ...
    {
      id: 5,
      src: "/placeholder.svg?height=400&width=600&text=Departamento+Tipo",
      title: "Departamento Tipo",
      category: "interior",
    },
    {
      id: 6,
    ...
    {
      id: 12,
      src: "/placeholder.svg?height=400&width=600&text=Sala+de+Estar",
      title: "Sala de Estar",
      category: "interior",
    },
  ],
...
export default function DomeGallery({ onReturnToProject }: DomeGalleryProps) {
