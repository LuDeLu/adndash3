...
const videos: VideoMedia[] = [
  { id: 11, src: '/images/fotos/domeresidence.mp4', title: 'Video muestra', type: 'video' },
]
...
export function MediaGalleryComponent({ projectId, setActiveSection }: MediaGalleryComponentProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Tabs defaultValue="all" className="w-full" onValueChange={(value) => setActiveTab(value as 'all' | 'image' | 'video')}>
      ...
      <div className="mt-8 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        >
          <FaEnvelope className="mr-2"/>Compartir por Email
        </Button>
      </div>
  ...
  return (
    <Card className="overflow-hidden relative">
      <CardContent className="p-0">
        ...
        <div className="p-4">
          <h3 className="font-semibold mb-2 text-sm sm:text-base">{media.type === 'image' ? media.alt : media.title}</h3>
