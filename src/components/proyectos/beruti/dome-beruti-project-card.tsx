...
import { berutiProjectInfo, getBerutiProjectStats, formatBerutiPrice } from "@/lib/dome-beruti-data"
import Image from "next/image"

type BerutiProjectCardProps = {
  onViewProject: () => void
  onViewFloorPlans: () => void
  onViewGallery: () => void
}

export function DomeBerutiProjectCard({ onViewProject, onViewFloorPlans, onViewGallery }: BerutiProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        <Image
          src={berutiProjectInfo.image || "/placeholder.svg"}
        ...
        <div className="absolute bottom-4 left-4 text-white">
          ...
          <p className="text-xl font-bold">{formatBerutiPrice(371600)}</p>
        </div>
      </div>
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-2">
            ...
            />
            <div>
              <CardTitle className="text-lg font-bold text-gray-900">{berutiProjectInfo.name}</CardTitle>
      ...
      <CardContent className="space-y-4">
        {/* Descripción */}
        <p className="text-sm text-gray-600 line-clamp-2">{berutiProjectInfo.description}</p>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="font-medium">{berutiProjectInfo.totalUnits}</p>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="font-medium">{berutiProjectInfo.floors}</p>
        ...
        <div className="border-t pt-3 text-center">
          <p className="text-xs text-gray-500">Torre de primera categoría con 3 niveles de cocheras</p>
        </div>
      </CardContent>
    </Card>
  )
